...
| **Task Pulling** | 🟡 **Pending** | 设计方案已定稿，即将开始重构 `internal/service`。 |
...
### P0: Phase 4.2 - 集群适配 (Cluster Adapter) - [Ready to Start]
...
*   **行动**:
    ...
    3.  **Communication**: 完善 `internal/service/communication`，实现 HTTP 通信逻辑。
