...
> ⚠️ **已过期 — 历史产物**  
> **最后更新**: 2026-08-14  
> **状态**: 本文档记录的 v1.0/v2.0 流程已被 [`Phase4.1_Pipeline_Fusion_Design.md`](./Phase4.1_Pipeline_Fusion_Design.md) 和 [`internal/core/pipeline/README.md`](../../internal/core/pipeline/README.md) 取代，保留此文档仅作历史参考。
