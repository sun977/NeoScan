...
// NmapCustomizeProbes 用户自定义的补充规则
// 格式与 nmap-service-probes 完全一致
// 建议包含针对内网特有服务或新出现的漏洞服务的指纹
var NmapCustomizeProbes = `
# User Custom Probes
# Add your custom probes here following the Nmap format
# Probe <protocol> <probename> <probestring>
# match <service> <pattern> <versioninfo>

# Example: SMB Negotiate
