...
// @param tool 扫描工具对象
// @return 错误信息
func (r *ScanToolRepository) CreateScanTool(ctx context.Context, tool *orchestrator_model_drop.ScanTool) error {
...
// @param id 扫描工具ID
// @return 扫描工具对象和错误信息
func (r *ScanToolRepository) GetScanToolByID(ctx context.Context, id uint) (*orchestrator_model_drop.ScanTool, error) {
	var tool orchestrator_model_drop.ScanTool
...
// @param name 工具名称
// @return 扫描工具对象和错误信息
func (r *ScanToolRepository) GetScanToolByName(ctx context.Context, name string) (*orchestrator_model_drop.ScanTool, error) {
	var tool orchestrator_model_drop.ScanTool
...
// @param tool 扫描工具对象
// @return 错误信息
func (r *ScanToolRepository) UpdateScanTool(ctx context.Context, tool *orchestrator_model_drop.ScanTool) error {
	tool.UpdatedAt = time.Now()
...
func (r *ScanToolRepository) DeleteScanTool(ctx context.Context, id uint) error {
	err := r.db.WithContext(ctx).Delete(&orchestrator_model_drop.ScanTool{}, id).Error
	if err != nil {
		// 记录删除失败日志
...
func (r *ScanToolRepository) GetScanToolList(ctx context.Context, offset, limit int, toolType *orchestrator_model_drop.ScanToolType, status *orchestrator_model_drop.ScanToolStatus) ([]*orchestrator_model_drop.ScanTool, int64, error) {
	var tools []*orchestrator_model_drop.ScanTool
	var total int64

	query := r.db.WithContext(ctx).Model(&orchestrator_model_drop.ScanTool{})
...
// @param toolType 工具类型
// @return 扫描工具列表和错误信息
func (r *ScanToolRepository) GetScanToolsByType(ctx context.Context, toolType orchestrator_model_drop.ScanToolType) ([]*orchestrator_model_drop.ScanTool, error) {
	var tools []*orchestrator_model_drop.ScanTool
	err := r.db.WithContext(ctx).Where("type = ? AND status = ?", toolType, orchestrator_model_drop.ScanToolStatusEnabled).Find(&tools).Error
	if err != nil {
		logger.LogError(err, "", 0, "", "scan_tool_list", "GET", map[string]interface{}{
...
// @param ctx 上下文
// @return 扫描工具列表和错误信息
func (r *ScanToolRepository) GetAvailableScanTools(ctx context.Context) ([]*orchestrator_model_drop.ScanTool, error) {
	var tools []*orchestrator_model_drop.ScanTool
	err := r.db.WithContext(ctx).Where("status = ?", orchestrator_model_drop.ScanToolStatusEnabled).Find(&tools).Error
	if err != nil {
		logger.LogError(err, "", 0, "", "scan_tool_list", "GET", map[string]interface{}{
...
func (r *ScanToolRepository) ScanToolExists(ctx context.Context, name string) (bool, error) {
	var count int64
	err := r.db.WithContext(ctx).Model(&orchestrator_model_drop.ScanTool{}).Where("name = ?", name).Count(&count).Error
	if err != nil {
...
// @param status 新状态
// @return 错误信息
func (r *ScanToolRepository) UpdateScanToolStatus(ctx context.Context, id uint, status orchestrator_model_drop.ScanToolStatus) error {
	err := r.db.WithContext(ctx).Model(&orchestrator_model_drop.ScanTool{}).Where("id = ?", id).Updates(map[string]interface{}{
		"status":     status,
		"updated_at": time.Now(),
	}).Error
	if err != nil {
...
func (r *ScanToolRepository) EnableScanTool(ctx context.Context, id uint) error {
	return r.UpdateScanToolStatus(ctx, id, orchestrator_model_drop.ScanToolStatusEnabled)
}
...
func (r *ScanToolRepository) DisableScanTool(ctx context.Context, id uint) error {
	return r.UpdateScanToolStatus(ctx, id, orchestrator_model_drop.ScanToolStatusDisabled)
}
...
func (r *ScanToolRepository) IncrementUsageCount(ctx context.Context, id uint, success bool) error {
	...
	err := r.db.WithContext(ctx).Model(&orchestrator_model_drop.ScanTool{}).Where("id = ?", id).Updates(updates).Error
	if err != nil {
		logger.LogError(err, "", id, "", "scan_tool_update", "PUT", map[string]interface{}{
...
// @param tool 扫描工具对象
// @return 错误信息
func (r *ScanToolRepository) UpdateScanToolWithTx(ctx context.Context, tx *gorm.DB, tool *orchestrator_model_drop.ScanTool) error {
	tool.UpdatedAt = time.Now()
...
func (r *ScanToolRepository) DeleteScanToolWithTx(ctx context.Context, tx *gorm.DB, id uint) error {
	err := tx.WithContext(ctx).Delete(&orchestrator_model_drop.ScanTool{}, id).Error
	if err != nil {
		// 记录删除失败日志
...
func (r *ScanToolRepository) UpdateScanToolFields(ctx context.Context, id uint, fields map[string]interface{}) error {
	...
	err := r.db.WithContext(ctx).Model(&orchestrator_model_drop.ScanTool{}).Where("id = ?", id).Updates(fields).Error
	if err != nil {
		logger.LogError(err, "", id, "", "scan_tool_update", "PUT", map[string]interface{}{
