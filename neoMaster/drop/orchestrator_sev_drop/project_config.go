...
// @param config 项目配置对象
// @return 创建的项目配置和错误信息
func (s *ProjectConfigService) CreateProjectConfig(ctx context.Context, config *orchestrator_model_drop.ProjectConfig) (*orchestrator_model_drop.ProjectConfig, error) {
	// 参数验证 - Linus式：消除特殊情况
	if config == nil {
...
func (s *ProjectConfigService) UpdateProjectConfig(ctx context.Context, id uint, config *orchestrator_model_drop.ProjectConfig) (*orchestrator_model_drop.ProjectConfig, error) {
	// 参数验证
	if id == 0 {
...
// @param id 项目配置ID
// @return 项目配置对象和错误信息
func (s *ProjectConfigService) GetProjectConfig(ctx context.Context, id uint) (*orchestrator_model_drop.ProjectConfig, error) {
	// 参数验证
	if id == 0 {
...
func (s *ProjectConfigService) ListProjectConfigs(ctx context.Context, offset, limit int, status *orchestrator_model_drop.ProjectConfigStatus, userID *uint) ([]*orchestrator_model_drop.ProjectConfig, int64, error) {
	// 参数验证
	if offset < 0 {
		offset = 0
	}
...
// @param config 项目配置对象
// @return 错误信息
func (s *ProjectConfigService) ValidateProjectConfig(ctx context.Context, config *orchestrator_model_drop.ProjectConfig) error {
	// 基础字段验证
...
func (s *ProjectConfigService) EnableProjectConfig(ctx context.Context, id uint) error {
	return s.updateProjectConfigStatus(ctx, id, orchestrator_model_drop.ProjectConfigStatusActive, "enable_project_config")
}
...
func (s *ProjectConfigService) DisableProjectConfig(ctx context.Context, id uint) error {
	return s.updateProjectConfigStatus(ctx, id, orchestrator_model_drop.ProjectConfigStatusInactive, "disable_project_config")
}
...
// @param ctx 上下文
// @return 项目配置列表和错误信息
func (s *ProjectConfigService) GetActiveProjectConfigs(ctx context.Context) ([]*orchestrator_model_drop.ProjectConfig, error) {
...
// @param userID 用户ID
// @return 项目配置列表和错误信息
func (s *ProjectConfigService) GetProjectConfigsByUser(ctx context.Context, userID uint) ([]*orchestrator_model_drop.ProjectConfig, error) {
	if userID == 0 {
...
// @param limit 限制数量
// @return 项目配置列表、总数和错误信息
func (s *ProjectConfigService) SearchProjectConfigs(ctx context.Context, keyword string, offset, limit int) ([]*orchestrator_model_drop.ProjectConfig, int64, error) {
...
// @param id 项目配置ID
// @return 项目配置对象和错误信息
func (s *ProjectConfigService) GetProjectConfigWithWorkflows(ctx context.Context, id uint) (*orchestrator_model_drop.ProjectConfig, error) {
...
// 私有方法：更新项目配置状态
func (s *ProjectConfigService) updateProjectConfigStatus(ctx context.Context, id uint, status orchestrator_model_drop.ProjectConfigStatus, operation string) error {
	// 参数验证
	if id == 0 {
...
// 私有方法：设置默认值
func (s *ProjectConfigService) setDefaultValues(config *orchestrator_model_drop.ProjectConfig) {
	// 设置默认状态
	if config.Status == 0 {
		config.Status = orchestrator_model_drop.ProjectConfigStatusInactive
	}
