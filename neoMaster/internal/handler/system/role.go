...
func (h *RoleHandler) CreateRole(c *gin.Context) {
	...
	// 记录成功创建角色的业务日志
	logger.LogBusinessOperation("create_role", userID, "", XRequestID, clientIP, "success", "角色创建成功", map[string]interface{}{
		"operation":  "create_role",
		"user_id":    userID,
		"role_id":    role.ID,
		"role_name":  role.Name,
...
func (h *RoleHandler) GetRoleList(c *gin.Context) {
	...
	// 记录成功获取角色列表的业务日志
	logger.LogBusinessOperation("get_role_list", userID, "", XRequestID, clientIP, "success", "获取角色列表成功", map[string]interface{}{
		"operation":    "get_role_list",
		"user_id":      userID,
		"page":         page,
		"limit":        limit,
...
func (h *RoleHandler) GetRoleByID(c *gin.Context) {
	...
	// 记录成功获取角色信息的业务日志
	logger.LogBusinessOperation("get_role_by_id", userID, "", XRequestID, clientIP, "success", "获取角色信息成功", map[string]interface{}{
		"operation":  "get_role_by_id",
		"user_id":    userID,
		"role_id":    roleID,
		"role_name":  role.Name,
...
func (h *RoleHandler) UpdateRole(c *gin.Context) {
	...
	// 记录成功更新角色的业务日志
	logger.LogBusinessOperation("update_role", userID, "", clientIP, XRequestID, "success", "角色更新成功", map[string]interface{}{
		"operation":  "update_role",
		"user_id":    userID,
		"role_id":    roleID,
		"role_name":  role.Name,
...
func (h *RoleHandler) DeleteRole(c *gin.Context) {
	...
	// 记录成功删除角色的业务日志
	logger.LogBusinessOperation("delete_role", userID, "", clientIP, XRequestID, "success", "角色删除成功", map[string]interface{}{
		"operation":  "delete_role",
		"user_id":    userID,
		"role_id":    roleID,
		"client_ip":  clientIP,
...
func (h *RoleHandler) ActivateRole(c *gin.Context) {
	...
	// 记录成功激活角色的业务日志
	logger.LogBusinessOperation("activate_role", userID, "", clientIP, XRequestID, "success", "角色激活成功", map[string]interface{}{
		"operation":  "activate_role",
		"user_id":    userID,
		"role_id":    roleID,
		"client_ip":  clientIP,
...
func (h *RoleHandler) DeactivateRole(c *gin.Context) {
	...
	// 记录成功禁用角色的业务日志
	logger.LogBusinessOperation("deactivate_role", userID, "", clientIP, XRequestID, "success", "角色禁用成功", map[string]interface{}{
		"operation":  "deactivate_role",
		"user_id":    userID,
		"role_id":    roleID,
		"client_ip":  clientIP,
