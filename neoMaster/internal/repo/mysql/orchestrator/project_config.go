...
func (r *ProjectConfigRepository) CreateProjectConfig(ctx context.Context, config *orchestrator.ProjectConfig) error {
	...
	if err != nil {
		// 记录创建失败日志
		logger.LogBusinessError(err, "", 0, "", "project_config_create", "POST", map[string]interface{}{
...
func (r *ProjectConfigRepository) GetProjectConfigByID(ctx context.Context, id uint) (*orchestrator.ProjectConfig, error) {
	...
	if err != nil {
		if err == gorm.ErrRecordNotFound {
			// 记录查询失败日志
			logger.LogBusinessError(fmt.Errorf("project config not found"), "", 0, "", "project_config_get", "GET", map[string]interface{}{
		...
		// 记录数据库错误日志
		logger.LogBusinessError(err, "", 0, "", "project_config_get", "GET", map[string]interface{}{
			"operation": "get_project_config_by_id",
			"id":        id,
			"timestamp": logger.NowFormatted(),
		})
...
func (r *ProjectConfigRepository) UpdateProjectConfig(ctx context.Context, config *orchestrator.ProjectConfig) error {
	...
	if err != nil {
		// 记录更新失败日志
		logger.LogBusinessError(err, "", uint(config.ID), "", "project_config_update", "PUT", map[string]interface{}{
...
func (r *ProjectConfigRepository) DeleteProjectConfig(ctx context.Context, id uint) error {
	...
	if err != nil {
		// 记录删除失败日志
		logger.LogBusinessError(err, "", id, "", "project_config_delete", "DELETE", map[string]interface{}{
...
func (r *ProjectConfigRepository) GetProjectConfigList(ctx context.Context, offset, limit int, status *orchestrator.ProjectConfigStatus) ([]*orchestrator.ProjectConfig, int64, error) {
	...
	if err := query.Count(&total).Error; err != nil {
		logger.LogBusinessError(err, "", 0, "", "project_config_list", "GET", map[string]interface{}{
...
func (r *ProjectConfigRepository) GetProjectConfigWithWorkflows(ctx context.Context, id uint) (*orchestrator.ProjectConfig, error) {
	...
	if err != nil {
		...
		logger.LogBusinessError(err, "", id, "", "project_config_get", "GET", map[string]interface{}{
...
func (r *ProjectConfigRepository) ProjectConfigExists(ctx context.Context, name string) (bool, error) {
	...
	if err != nil {
		logger.LogBusinessError(err, "", 0, "", "project_config_exists", "GET", map[string]interface{}{
...
func (r *ProjectConfigRepository) UpdateProjectConfigStatus(ctx context.Context, id uint, status orchestrator.ProjectConfigStatus) error {
	...
	if err != nil {
		logger.LogBusinessError(err, "", id, "", "project_config_update", "PUT", map[string]interface{}{
...
func (r *ProjectConfigRepository) BeginTx() (*gorm.DB, error) {
	tx := r.db.Begin()
	if tx.Error != nil {
		logger.LogBusinessError(tx.Error, "", 0, "", "project_config_transaction", "BEGIN", map[string]interface{}{
...
func (r *ProjectConfigRepository) UpdateProjectConfigWithTx(ctx context.Context, tx *gorm.DB, config *orchestrator.ProjectConfig) error {
	...
	if err != nil {
		// 记录更新失败日志
		logger.LogBusinessError(err, "", uint(config.ID), "", "project_config_update_with_tx", "PUT", map[string]interface{}{
...
func (r *ProjectConfigRepository) DeleteProjectConfigWithTx(ctx context.Context, tx *gorm.DB, id uint) error {
	...
	if err != nil {
		// 记录删除失败日志
		logger.LogBusinessError(err, "", id, "", "project_config_delete_with_tx", "DELETE", map[string]interface{}{
