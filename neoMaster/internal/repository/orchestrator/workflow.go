...
// @return 错误信息
func (r *WorkflowConfigRepository) CreateWorkflowConfig(ctx context.Context, config *scan_config.WorkflowConfig) error {
...
// @param id 工作流配置ID
// @return 工作流配置对象和错误信息
func (r *WorkflowConfigRepository) GetWorkflowConfigByID(ctx context.Context, id uint) (*scan_config.WorkflowConfig, error) {
	var config scan_config.WorkflowConfig
...
// @return 工作流配置对象和错误信息
func (r *WorkflowConfigRepository) GetWorkflowConfigByName(ctx context.Context, name string, projectID *uint) (*scan_config.WorkflowConfig, error) {
	var config scan_config.WorkflowConfig
...
// @param config 工作流配置对象
// @return 错误信息
func (r *WorkflowConfigRepository) UpdateWorkflowConfig(ctx context.Context, config *scan_config.WorkflowConfig) error {
	config.UpdatedAt = time.Now()
...
func (r *WorkflowConfigRepository) DeleteWorkflowConfig(ctx context.Context, id uint) error {
	err := r.db.WithContext(ctx).Delete(&scan_config.WorkflowConfig{}, id).Error
	if err != nil {
		// 记录删除失败日志
...
func (r *WorkflowConfigRepository) GetWorkflowConfigList(ctx context.Context, offset, limit int, projectID *uint, status *scan_config.WorkflowStatus) ([]*scan_config.WorkflowConfig, int64, error) {
	var configs []*scan_config.WorkflowConfig
	var total int64
	
	query := r.db.WithContext(ctx).Model(&scan_config.WorkflowConfig{})
...
// @return 工作流配置列表和错误信息
func (r *WorkflowConfigRepository) GetWorkflowConfigsByProject(ctx context.Context, projectID uint) ([]*scan_config.WorkflowConfig, error) {
	var configs []*scan_config.WorkflowConfig
	err := r.db.WithContext(ctx).Where("project_config_id = ? AND status = ?", projectID, scan_config.WorkflowStatusActive).Find(&configs).Error
	if err != nil {
		logger.LogError(err, "", 0, "", "workflow_config_list", "GET", map[string]interface{}{
...
// @param ctx 上下文
// @return 工作流配置列表和错误信息
func (r *WorkflowConfigRepository) GetActiveWorkflowConfigs(ctx context.Context) ([]*scan_config.WorkflowConfig, error) {
	var configs []*scan_config.WorkflowConfig
	err := r.db.WithContext(ctx).Where("status = ?", scan_config.WorkflowStatusActive).Find(&configs).Error
	if err != nil {
		logger.LogError(err, "", 0, "", "workflow_config_list", "GET", map[string]interface{}{
...
func (r *WorkflowConfigRepository) WorkflowConfigExists(ctx context.Context, name string, projectID *uint) (bool, error) {
	var count int64
	query := r.db.WithContext(ctx).Model(&scan_config.WorkflowConfig{}).Where("name = ?", name)
...
// @return 工作流配置列表和错误信息
func (r *WorkflowConfigRepository) GetWorkflowConfigsByTrigger(ctx context.Context, triggerType scan_config.WorkflowTriggerType) ([]*scan_config.WorkflowConfig, error) {
	var configs []*scan_config.WorkflowConfig
	err := r.db.WithContext(ctx).Where("trigger_type = ? AND status = ?", triggerType, scan_config.WorkflowStatusActive).Find(&configs).Error
	if err != nil {
		logger.LogError(err, "", 0, "", "workflow_config_list", "GET", map[string]interface{}{
...
// @param status 新状态
// @return 错误信息
func (r *WorkflowConfigRepository) UpdateWorkflowConfigStatus(ctx context.Context, id uint, status scan_config.WorkflowStatus) error {
	err := r.db.WithContext(ctx).Model(&scan_config.WorkflowConfig{}).Where("id = ?", id).Updates(map[string]interface{}{
		"status":     status,
		"updated_at": time.Now(),
	}).Error
	if err != nil {
...
func (r *WorkflowConfigRepository) EnableWorkflowConfig(ctx context.Context, id uint) error {
	return r.UpdateWorkflowConfigStatus(ctx, id, scan_config.WorkflowStatusActive)
}
...
func (r *WorkflowConfigRepository) DisableWorkflowConfig(ctx context.Context, id uint) error {
	return r.UpdateWorkflowConfigStatus(ctx, id, scan_config.WorkflowStatusInactive)
}
...
func (r *WorkflowConfigRepository) IncrementExecutionCount(ctx context.Context, id uint, success bool, executionTime float64) error {
	...
	err := r.db.WithContext(ctx).Model(&scan_config.WorkflowConfig{}).Where("id = ?", id).Updates(updates).Error
	if err != nil {
		logger.LogError(err, "", id, "", "workflow_config_update", "PUT", map[string]interface{}{
...
// @param config 工作流配置对象
// @return 错误信息
func (r *WorkflowConfigRepository) UpdateWorkflowConfigWithTx(ctx context.Context, tx *gorm.DB, config *scan_config.WorkflowConfig) error {
	config.UpdatedAt = time.Now()
...
func (r *WorkflowConfigRepository) DeleteWorkflowConfigWithTx(ctx context.Context, tx *gorm.DB, id uint) error {
	err := tx.WithContext(ctx).Delete(&scan_config.WorkflowConfig{}, id).Error
	if err != nil {
		// 记录删除失败日志
...
func (r *WorkflowConfigRepository) UpdateWorkflowConfigFields(ctx context.Context, id uint, fields map[string]interface{}) error {
	...
	err := r.db.WithContext(ctx).Model(&scan_config.WorkflowConfig{}).Where("id = ?", id).Updates(fields).Error
	if err != nil {
		logger.LogError(err, "", id, "", "workflow_config_update", "PUT", map[string]interface{}{
