...
-- 默认扫描类型
INSERT INTO `agent_scan_types` (`name`, `display_name`, `description`, `category`, `config_template`) VALUES
('port_scan', '端口扫描', '对目标主机进行端口扫描，发现开放的服务端口', 'network', '{"timeout": 30, "threads": 100, "ports": "1-65535"}'),
('vuln_scan', '漏洞扫描', '对目标进行漏洞扫描，发现安全漏洞', 'security', '{"severity": "medium", "timeout": 300, "plugins": ["cve", "exploit"]}'),
...
('neoscan-agent-001', 25.5, 45.2, 68.1, 1048576, 2097152, 5, 2, 156, 3, 'working', 'port_scan', '{"nmap": {"status": "running", "pid": 12345}, "nuclei": {"status": "idle"}}'),
('neoscan-agent-002', 15.8, 32.4, 55.7, 5242880, 10485760, 12, 4, 892, 8, 'working', 'vuln_scan', '{"nmap": {"status": "idle"}, "nuclei": {"status": "running", "pid": 23456}, "masscan": {"status": "idle"}}'),
...
('neoscan-agent-001', 'task_001', 'port_scan', '2025-01-26 10:00:00', '2025-01-26 10:01:00', NULL, 'running', NULL),
('neoscan-agent-001', 'task_002', 'vuln_scan', '2025-01-26 09:30:00', '2025-01-26 09:31:00', '2025-01-26 09:45:00', 'completed', '{"vulnerabilities": 3, "severity": "medium", "details": "发现3个中等风险漏洞"}'),
('neoscan-agent-002', 'task_003', 'web_scan', '2025-01-26 11:00:00', '2025-01-26 11:02:00', NULL, 'running', NULL),
('neoscan-agent-003', 'task_004', 'port_scan', '2025-01-26 08:00:00', '2025-01-26 08:01:00', '2025-01-26 08:15:00', 'failed', '{"error": "连接超时", "code": "TIMEOUT"}');
